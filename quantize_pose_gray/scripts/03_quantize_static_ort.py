...
if preprocess_model:
    ...
    try:
        ...
        print("WARNING: preprocess_model not available; using onnx.optimizer")
        ...
        model = onnx_opt.optimize(model, passes)
        onnx.save(model, PREPROC_ONNX)
        model_input_path = PREPROC_ONNX
    except Exception:
        print("WARNING: onnx optimizer unavailable; quantizing original FP32 graph")
